...
TERRANIGMA_TAB_RANGES = {
    ...
    { from = 0x013C, to = 0x013D, tab = "Dungeons/Ra Tree/Cave 3" },
    { from = 0x013A, to = 0x013B, tab = "Dungeons/Ra Tree/Cave 4" },
    { from = 0x013E, to = 0x013F, tab = "Dungeons/Ra Tree/Cave 5" },
    { from = 0x0140, to = 0x0140, tab = "Dungeons/Ra Tree/Cave 2" },
    ...
    { from = 0x0154, to = 0x0154, tab = "Dungeons/Great Cliff/Roc Spear Cave + Fourth Cave" },
    { from = 0x0157, to = 0x0159, tab = "Dungeons/Great Cliff/Roc Spear Cave + Fourth Cave" },
    { from = 0x0152, to = 0x0153, tab = "Dungeons/Great Cliff/Third + Fifth Cave" },
    { from = 0x015A, to = 0x015A, tab = "Dungeons/Great Cliff/Slope 1" },
    { from = 0x015B, to = 0x015B, tab = "Dungeons/Great Cliff/Slope 2" },
    { from = 0x0148, to = 0x0149, prev_any = { 0x0152, 0x0149, 0x0148, 0x0154, 0x015A}, when = function() return not great_cliff_hold_left_done() end, tab = "Dungeons/Great Cliff/Outside Counterclockwise" },
    { from = 0x0145, to = 0x0149, prev_any = { 0x0145, 0x0146, 0x0148, 0x015A}, when = function() return great_cliff_hold_left_done() end, tab = "Dungeons/Great Cliff/Outside Sharp Claws" },
    ...
    { from = 0x01E8, to = 0x01E8, tab = "Dungeons/Sylvain Castle/Back Room 1" },
    ...
    { from = 0x042F, to = 0x0430, tab = "Dungeons/Dragoon Castle/1st Floor Room 3" },
    { from = 0x0426, to = 0x0426, tab = "Dungeons/Dragoon Castle/Left Side" },
    { from = 0x0431, to = 0x0434, tab = "Dungeons/Dragoon Castle/Left Side" },
}
